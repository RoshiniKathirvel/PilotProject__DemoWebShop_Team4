...
#keyword to click shopping cart button
    bookmoduleresource.click on shopping cart button

#keyword to  click remove option
     
#keyword to click update shopping cart
#keyword to assert product has removed from shopping cart